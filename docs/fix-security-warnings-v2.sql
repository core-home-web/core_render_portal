-- =====================================================
-- FIX SECURITY ADVISOR WARNINGS (V2)
-- =====================================================
-- Fixed version that drops functions before recreating them
-- Run this AFTER complete-user-profiles-setup.sql
-- =====================================================
...
DROP FUNCTION IF EXISTS get_user_project(UUID) CASCADE;
DROP FUNCTION IF EXISTS update_user_project(UUID, TEXT, TEXT, TIMESTAMP WITH TIME ZONE, JSONB) CASCADE;
DROP FUNCTION IF EXISTS invite_user_to_project(UUID, UUID, TEXT, TEXT, TEXT) CASCADE;
DROP FUNCTION IF EXISTS get_invitation_details(TEXT) CASCADE;
DROP FUNCTION IF EXISTS can_accept_invitation(TEXT, TEXT) CASCADE;
DROP FUNCTION IF EXISTS accept_project_invitation(TEXT, UUID, TEXT) CASCADE;
...
-- =====================================================
-- PART 3: Drop insecure view
-- =====================================================
DROP VIEW IF EXISTS project_collaborators_with_users CASCADE;

-- =====================================================
-- PART 4: Create secure function for collaborators
-- =====================================================
...
BEGIN
  ...
  RAISE NOTICE '✓ Functions dropped and recreated';
  RAISE NOTICE '✓ Removed insecure auth.users view';
  RAISE NOTICE '✓ Created secure collaborator function';
  RAISE NOTICE '';
  RAISE NOTICE '🔄 Next: Run Security Advisor to verify';
  RAISE NOTICE '━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━';
END $$;
